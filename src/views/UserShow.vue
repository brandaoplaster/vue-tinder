<template>
  <div>
    <div>
      <swiper>
        <swiper-slide v-for="photo in currentUser.photos" :key="photo.url">
          <img :src="photo.url">
        </swiper-slide>
      </swiper>
      ...
      <div v-else class="columns is-mobile is-gapless is-centered action-buttons">
        <div class="column is-12">
      ...
      <div class="columns is-mobile is-gapless is-multiline user-info">
        ...
        <div class="column is-12 has-text-centered">
          <h5 v-if="currentUser.description" class="is-size-6 has-text-grey description">
